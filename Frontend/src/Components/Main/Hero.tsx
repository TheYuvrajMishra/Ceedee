          ...
          <div className="flex flex-col gap-8 items-center md:items-end">
            ...
            <div className="flex flex-row gap-2 md:gap-4 justify-center">
              ...
              >
                ...
                <span className="hidden md:inline">EXPLORE OPPORTUNITIES</span>
              ...
              <Link
                ...
                className="border group rounded-full border-white cursor-pointer text-white hover:bg-white hover:text-black px-4 py-2 md:px-8 md:py-3 transition-colors duration-300 tracking-wider text-xs md:text-sm whitespace-nowrap"
              >
                <span className="md:hidden">PARTNER UP</span>
